// =============================
// Shipping Calculator Script (FINAL VERSION)
// =============================
...
// manualGrossWeightInput อาจไม่มีใน HTML บางเวอร์ชัน (ใช้ ?. เช็คเอา)
...
// 1. ฟังก์ชัน Save ลง Firebase (เรียกจากปุ่ม Save in Calculator)
window.saveCalculation = async function () {
    // ตรวจสอบว่าคำนวณราคาหรือยัง
    ...
    const entry = {
        ...
        // [แก้ Error] ใส่ ?. เช็คค่า และใช้ total-weight ถ้าหา manual-gross-weight ไม่เจอ
...
// 2. ฟังก์ชันเพิ่มลง Database (Helper)
...
// 3. ฟังก์ชันดึงข้อมูลมาแสดง (Realtime + Pagination)
let allHistoryDocs = [];
let currentPage = 1;
...
function initRealtimeHistory() {
    ...
    try {
        // ดึงข้อมูลทั้งหมดมาเก็บไว้ในตัวแปร (Client-side pagination)
        // เพื่อให้สามารถเลือกหน้า (Jump to page) ได้ง่ายและเร็ว
        ...
        onSnapshot(q, (querySnapshot) => {
            ...
            console.log("History load error (likely missing config):", error);
        });
    } catch (e) {
...
function renderHistoryPage(page) {
    ...
    if (pageDocs.length === 0) {
        ...
        pageDocs.forEach((h) => {
            ...
            // [แก้ไขใหม่] ตรวจสอบแบบยืดหยุ่น (Case-insensitive)
            let boxText = h.boxOption || "-";
            const rawBox = String(h.boxOption || "").toLowerCase().trim();

            if (rawBox.includes("include")) {
                boxText = translations[currentLang]?.lbl_box_include || "Include Box";
            } else if (rawBox.includes("exclude")) {
                boxText = translations[currentLang]?.lbl_box_exclude || "Exclude Box";
            }
...
// [เพิ่มใหม่] ใส่ราคาเริ่มต้นจากรูปภาพ
function getInitialRates() {
    const rates = {};

    // --- DHL Data (จากรูปภาพ) ---
    rates['dhl'] = {
        "0.5": 1837.60, "1.0": 2059.47, "1.5": 2281.34, "2.0": 2503.21, "2.5": 2777.72,
        "3.0": 2988.31, "3.5": 3198.90, "4.0": 3409.49, "4.5": 3620.08, "5.0": 3830.67,
        "5.5": 4017.44, "6.0": 4204.21, "6.5": 4390.98, "7.0": 4577.75, "7.5": 4764.52,
        "8.0": 4951.29, "8.5": 5138.06, "9.0": 5324.83, "9.5": 5511.60, "10.0": 5698.37,
        "10.5": 5717.17, "11.0": 5735.97, "11.5": 5754.77, "12.0": 5773.57, "12.5": 5792.37,
        "13.0": 5811.17, "13.5": 5829.97, "14.0": 5848.77, "14.5": 5867.57, "15.0": 5886.37,
        "15.5": 5905.17, "16.0": 5923.97, "16.5": 5942.77, "17.0": 5961.57, "17.5": 5980.37,
        "18.0": 5999.17, "18.5": 6017.97, "19.0": 6036.77, "19.5": 6055.57, "20.0": 6074.37,
        "20.5": 6179.67, "21.0": 6284.97, "21.5": 6390.27, "22.0": 6495.57, "22.5": 6600.87,
        "23.0": 6706.17, "23.5": 6811.47, "24.0": 6916.77, "24.5": 7022.07, "25.0": 7127.37,
        "25.5": 7232.67, "26.0": 7337.97, "26.5": 7443.27, "27.0": 7548.57, "27.5": 7653.87,
        "28.0": 7759.17, "28.5": 7864.47, "29.0": 7969.77, "29.5": 8075.07, "30.0": 8180.37,
        // Ranges
        "31-44": 130.37, "45-70": 130.37, "71-99": 112.81, "100-299": 112.81, "> 300": 121.58
    };

    // --- SF Data (จากรูปภาพ) ---
    rates['sf'] = {
        "0.5": 534.00, "1.0": 666.00, "1.5": 795.00, "2.0": 927.00, "2.5": 1056.00,
        "3.0": 1179.00, "3.5": 1299.00, "4.0": 1410.00, "4.5": 1530.00, "5.0": 1641.00,
        "5.5": 1755.00, "6.0": 1863.00, "6.5": 197.00,
        "7.0": 2085.00, "7.5": 2199.00,
        "8.0": 2307.00, "8.5": 2424.00, "9.0": 2529.00, "9.5": 2646.00, "10.0": 2754.00,
        "10.5": 2853.00, "11.0": 2958.00, "11.5": 3060.00, "12.0": 3162.00, "12.5": 3267.00,
        "13.0": 3366.00, "13.5": 3468.00, "14.0": 3573.00, "14.5": 3672.00, "15.0": 3777.00,
        "15.5": 3876.00, "16.0": 3975.00, "16.5": 4071.00, "17.0": 4170.00, "17.5": 4269.00,
        "18.0": 4368.00, "18.5": 4467.00, "19.0": 4563.00, "19.5": 4638.00, "20.0": 4740.00,
        // ค่าช่วงปลาย
        "20.5": 4740.00, "21.0": 4977.00, "21.5": 4977.00, "22.0": 5214.00, "22.5": 5214.00,
        "23.0": 5451.00, "23.5": 5451.00, "24.0": 5688.00, "24.5": 5688.00, "25.0": 5925.00,
        "25.5": 5925.00, "26.0": 6162.00, "26.5": 6162.00, "27.0": 6399.00, "27.5": 6399.00,
        "28.0": 6636.00, "28.5": 6636.00, "29.0": 6873.00, "29.5": 6873.00, "30.0": 7110.00,
        // Ranges
        "31-44": 237.00, "45-70": 237.00, "71-99": 234.00, "100-299": 234.00, "> 300": 222.00
    };
    ...
    rates['v01198'] = {
        "0 - 10.0": 13, "10.1 - 45.0": 12, "45.1 - 100.0": 11,
        "100.1 - 300.0": 10, ">300": 9, "special": 18
    };

    return rates;
}

// [ปรับปรุง] ถ้าไม่มีข้อมูลในเครื่อง ให้ใช้ค่า Default
function loadRates() {
    let rates = {};
    try {
    ...
    // ถ้าว่าง ให้สร้างข้อมูลเริ่มต้น
    if (Object.keys(rates).length === 0) {
        rates = getInitialRates();
        localStorage.setItem(RATES_KEY, JSON.stringify(rates));
        // บันทึก config แถวด้วย เพื่อให้ Ranges ตรงกัน
...
function getRateFromStorage(vendor, val) {
    ...
    // Logic การปัดเศษ (0.5 Step) สำหรับ Air
...
allInputs.forEach(el => {
    el.addEventListener("focus", function () {
        if (this.value && !textFields.includes(this.id)) {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Add event listener to radio buttons for immediate calculation
