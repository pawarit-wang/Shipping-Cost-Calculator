...
const translations = {
    en: {
        ...
        nav_table: "Table", nav_calc: "Calculator", nav_history: "History", nav_duty: "Duty Tax",
        ...
        // Duty Page
        header_duty_calc: "Import Duty Calculator",
        subheader_shipment_info: "Shipment Information",
        subheader_valuation_tax: "Valuation & Tax",
        lbl_forwarder: "Forwarder",
        lbl_qty_pieces: "Quantity (Pieces)",
        lbl_origin_value: "Origin Value",
        lbl_local_value: "Local Value (THB)",
        lbl_freight_rate: "Freight Rate",
        lbl_weight_kg: "Weight (Kg)",
        lbl_freight_value: "Freight Value (THB)",
        lbl_insurance_rate: "Insurance Rate (%)",
        lbl_insurance_value: "Insurance Value (THB)",
        lbl_duty_rate: "Duty Rate (%)",
        lbl_import_duty_fee: "Import Duty Fee",
        lbl_storage: "Storage",
        lbl_service_base: "Service (Base)",
        lbl_total_import_cost: "TOTAL IMPORT COST",
        lbl_duty_storage_service: "(Duty + Storage + Service Base)",
        lbl_cost_per_piece: "COST PER PIECE",
        ph_name: "Name",
        ph_pn: "P/N",
        ph_code: "Code",
        ph_eg_50: "e.g. 50",
    ...
    th: {
        ...
        nav_table: "ตาราง", nav_calc: "คำนวณราคา", nav_history: "ประวัติ", nav_duty: "ภาษีนำเข้า",
        ...
        // Duty Page
        header_duty_calc: "โปรแกรมคำนวณภาษีนำเข้า",
        subheader_shipment_info: "ข้อมูลการจัดส่ง",
        subheader_valuation_tax: "การประเมินมูลค่าและภาษี",
        lbl_forwarder: "บริษัทขนส่ง (Forwarder)",
        lbl_qty_pieces: "จำนวน (ชิ้น)",
        lbl_origin_value: "มูลค่าต้นทาง",
        lbl_local_value: "มูลค่าท้องถิ่น (THB)",
        lbl_freight_rate: "อัตราค่าขนส่ง",
        lbl_weight_kg: "น้ำหนัก (Kg)",
        lbl_freight_value: "ค่าขนส่ง (THB)",
        lbl_insurance_rate: "อัตราประกันภัย (%)",
        lbl_insurance_value: "ค่าประกันภัย (THB)",
        lbl_duty_rate: "อัตราภาษี (%)",
        lbl_import_duty_fee: "ค่าภาษีนำเข้า",
        lbl_storage: "ค่าจัดเก็บ (Storage)",
        lbl_service_base: "ค่าบริการ (Service)",
        lbl_total_import_cost: "ต้นทุนการนำเข้ารวม",
        lbl_duty_storage_service: "(ภาษี + ค่าจัดเก็บ + ค่าบริการ)",
        lbl_cost_per_piece: "ต้นทุนต่อชิ้น",
        ph_name: "ชื่อสินค้า",
        ph_pn: "รหัส",
        ph_code: "รหัสศุลกากร",
        ph_eg_50: "เช่น 50",
    ...
    cn: {
        ...
        nav_table: "表格", nav_calc: "计算器", nav_history: "历史记录", nav_duty: "进口税",
        app_title: "运费计算器",
        ...
        // Duty Page
        header_duty_calc: "进口税计算器",
        subheader_shipment_info: "发货信息",
        subheader_valuation_tax: "估值与税收",
        lbl_forwarder: "货代 (Forwarder)",
        lbl_qty_pieces: "数量 (件)",
        lbl_origin_value: "原产地价值",
        lbl_local_value: "本地价值 (THB)",
        lbl_freight_rate: "运费费率",
        lbl_weight_kg: "重量 (Kg)",
        lbl_freight_value: "运费 (THB)",
        lbl_insurance_rate: "保险费率 (%)",
        lbl_insurance_value: "保险费 (THB)",
        lbl_duty_rate: "税率 (%)",
        lbl_import_duty_fee: "进口税费",
        lbl_storage: "仓储费",
        lbl_service_base: "服务费 (基础)",
        lbl_total_import_cost: "总进口成本",
        lbl_duty_storage_service: "(税 + 仓储 + 服务费)",
        lbl_cost_per_piece: "单件成本",
        ph_name: "名称",
        ph_pn: "件号",
        ph_code: "编码",
        ph_eg_50: "例如 50",
